...
export const options = {
  stages: [
    { duration: '5m', target: 5000 },   // 5분 동안 5000명까지 증가
    { duration: '8m', target: 15000 },  // 8분 동안 15000명까지 증가
    { duration: '12m', target: 30000 }, // 12분 동안 30000명까지 증가
    { duration: '20m', target: 30000 }, // 20분 동안 30000명 유지
    { duration: '5m', target: 0 },      // 5분 동안 0명까지 감소
  ],
  thresholds: {
    http_req_duration: ['p(95)<20000'], // 95%의 요청이 20초 이내
    http_req_failed: ['rate<0.4'],      // 에러율 40% 미만
    errors: ['rate<0.4'],               // 커스텀 에러율 40% 미만
    success: ['rate>0.6'],              // 성공률 60% 이상
  },
};
